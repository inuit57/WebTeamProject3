...
<body>
	...
	<table border="1">
		...
		if(startPage > pageBlock){
			%>
			<a href="./InqueryAdminList.ai?pageNum=<%=startPage-pageBlock%>">[이전]</a>
			<% 
		}
		...
		for(int i = startPage;i<=endPage;i++){
			%>
			<a href="./InqueryAdminList.ai?pageNum=<%=i%>">[<%=i %>]</a>
			<% 
		}
		...
		if(endPage < pageCount){
			%>
			<a href="./InqueryAdminList.ai?pageNum=<%=startPage+pageBlock%>">[다음]</a>
			<%
